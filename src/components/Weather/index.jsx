        ...
        fetch(url).then((response) => response.json())
            .then((data) => {
                ...
                const currentWeather = {
                    ...
                    condition: `Conditions are ${data.weather[0].description}`,
                ...
                {weather && (
                    ...
                    <div className="weather p-2 max-w-96 border-2 md:border-4 border-amber-500 rounded-lg md:text-xl">
                        ...
                        <div className="p-1.5 rounded">
                            <img className="p-1.5" src={`https://openweathermap.org/img/wn/${weather.icon}@2x.png`}></img>
                        </div>
                        <p className="m-0.5 p-0.5 bg-amber-100 text-cyan-900 rounded ">{weather.condition}</p>
